"""
Django settings for lifeplan_genius project.
...
MIDDLEWARE = [
    ...
    'lifeplan_genius.middleware.AuthenticationMiddleware',  # Custom authentication middleware
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'supabase_local_db'),
...
# CORS settings
CORS_ALLOW_ALL_ORIGINS = DEBUG  # In development
