// Test script to verify the decimal cost columns fix
...
const testData = {
  ...
  category: 'test',
  item: 'Decimal Test Item',
  frequency: '4x per year',
  cpt_code: '99214',
  cpt_description: 'Office Visit',
  // Use decimal values for all cost fields
  min_cost: parseFloat((75.25).toFixed(2)),
  avg_cost: parseFloat((80.50).toFixed(2)),
  max_cost: parseFloat((85.75).toFixed(2)),
  annual_cost: parseFloat((322.00).toFixed(2)),
  lifetime_cost: parseFloat((9338.00).toFixed(2)),
  start_age: 51,
  end_age: 80,
  is_one_time: false
};
